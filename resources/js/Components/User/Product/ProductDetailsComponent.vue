                ...
                <div id="product-carousel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner bg-light">
                        ...
                        <div class="carousel-item">
                            <img class="w-100 h-100"
                                src="https://images.unsplash.com/photo-1543163521-1bf539c55dd2?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fHByb2R1Y3QlMjBpbWFnZXxlbnwwfHwwfHx8MA%3D%3D"
                                alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100"
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        ...
                        <button class="btn btn-info px-3" style="margin-left: 15px;"><i class="fa fa-shopping-cart"></i> Add To
                            Cart</button>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="media" style="margin-bottom: 15px;">
                                        <img src="https://img.freepik.com/premium-vector/avatar-profile-icon-flat-style-male-user-profile-vector-illustration-isolated-background-man-profile-sign-business-concept_157943-38764.jpg?semt=ais_hybrid" alt="Image" class="img-fluid"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form>
                                        <div class="form-group">
                                            <label for="message" style="margin-bottom: 10px;">Your Review *</label>
                                        ...
                                        <div class="form-group" style="margin-top: 15px;">
                                            <label for="email" style="margin-bottom: 10px;">Your Email *</label>
